    ...
    def extra_state_attributes(self):
        ...
        for entity_id, data in sorted_devices:
            ...
            devices.append({
                ...
                "target_coverage": data.get("target_coverage", 90),
                "recommendation": data.get("recommendation"),
                "is_running": data.get("is_running", False),
                "current_power": data.get("current_power", 0),
                "power_state": data.get("power_state"),
                "power_unit": data.get("power_unit"),
                "power_last_updated": data.get("power_last_updated"),
                "power_is_stale": data.get("power_is_stale"),
                "device_state_sensor": data.get("device_state_sensor"),
                "device_state": data.get("device_state"),
                "device_state_last_updated": data.get("device_state_last_updated"),
                "device_state_is_stale": data.get("device_state_is_stale"),
        ...
        return {
            ...
            "pv_forecast_sensor": context.get("pv_forecast_sensor"),
            "home_base_load_sensor": context.get("home_base_load_sensor"),
            "pv_current_power_sensor": context.get("pv_current_power_sensor"),
            "battery_soc_sensor": context.get("battery_soc_sensor"),
            "battery_energy_sensor": context.get("battery_energy_sensor"),
            "battery_capacity_sensor": context.get("battery_capacity_sensor"),
            ...
            "battery_charge_power": context.get("battery_charge_power"),
            "battery_discharge_power": context.get("battery_discharge_power"),
            "grid_import_energy_kwh": context.get("grid_import_energy_kwh"),
            "grid_export_energy_kwh": context.get("grid_export_energy_kwh"),
